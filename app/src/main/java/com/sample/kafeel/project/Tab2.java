...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(com.sample.kafeel.project.R.layout.fragment_tab2, container, false);
        fab=view.findViewById(com.sample.kafeel.project.R.id.floatingActionButton);
        ...
        transaction = manager.beginTransaction().add(com.sample.kafeel.project.R.id.book_root_view, new AddBook());
